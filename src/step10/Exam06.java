...
public class Exam06 {
  public static void main(String[] args) {
    ...
    // Score4에서 summary()와 average()의 접근 레벨이 default이기 때문에
    // => 같은 패키지에 속해있는 모든 클래스에서 사용간으 했다.
    // => 그러나 Score5에서는 두 메서드 모드 pricate 레벨을 갖기 때문에
...
- 잘못된 접근을 차단함으로써 클래스의 오용을 막을 수 있다.
*/
