...
// 사용할 땐 Exam04 방법을 사용하지 말고 Exam05방법을 사용한다.
...
public class Exam05 {
  ...
  public static void main(String[] args) {
    ...
    calc1.multiple(3); // 0 + 2 * 3
    calc2.minus(7); // 0 + 3 - 7

    calc1.plus(6); // 0 + 2 * 3 + 6
    calc2.multiple(2); // 0 + 3 - 7 * 2

    calc1.minus(7); //0 + 2 * 3 + 6 - 7
    calc2.plus(27); // 0 + 3 - 7 * 2 + 27
