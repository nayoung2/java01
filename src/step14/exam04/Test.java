...
public class Test {
  public static void main(String[] args) {
    ...
    // 원래 Car의 존재이유가 무엇인가?  (기존 존재하는 코드들의 공통된 코드를 정리하기 위함.)
    // Car c3 = new Car(); // 추상클래스이기 때문에 인스턴스를 생성할 수 없다.
                          //오류 src/step14/exam04/Test.java:16: error: Car is abstract; cannot be instantiated
...
- 직접 인스턴스를 생성할 수 없다.
- 추상 메서드를 가질 수 있다.
- 서브 클래스에게 속성이나 메서드를 상속해 주는 역할을 한다.
