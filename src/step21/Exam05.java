// 주제: Collection API - ArratList5 --> 로컬 중첩 클래스 적용
package step21;
...
public class Exam05 {
  ...
  public static void main(String[] args) {
    ...
    // 확인 한 다음에 다시 이 위치로 내려와서 이 코드의 의미를 이해하려고
    // 노력할 것이다.
    // 그나마 이 예제는 스크롤을 살짝만 올려도 MyComparator 클래스의 코드를
    // 확인할 수 있어서 다행이다.
    // 만약 메서드의 코드가 길어서 여러 페이지를 스크롤 해야만 찾을 수 있다면
    // 아~~~~~~ 얼마나 피곤할 것인가?
    // 좋은 해결책?
    ...
    //
    // 위의 두 개의 문제를 한꺼번에 해결하는 방법? 익명 이너 클래스
ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
    // 익명이너클래스 - 코드를 근처에 두며 객체를 한 개만 만든다.
